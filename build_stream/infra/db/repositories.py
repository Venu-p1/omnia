...
class SqlJobRepository:
    ...
    def save(self, job: Job) -> None:
        ...
        if existing:
            # Update existing job with optimistic locking
            ...
            existing.catalog_digest = job.catalog_digest
...
class SqlStageRepository:
    ...
    def save(self, stage: Stage) -> None:
        ...
        if existing:
            # Update existing stage with optimistic locking
...
class SqlAuditEventRepository:
    ...
    def find_by_job(self, job_id: JobId) -> List[AuditEvent]:
        ...
        stmt = select(AuditEventModel).where(
            AuditEventModel.job_id == str(job_id)
